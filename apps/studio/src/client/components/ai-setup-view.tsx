// Local-only mode - AI setup without Google sign-in
...
export function AISetupView({ mode }: { mode: "setup" | "sign-in" }) {
  ...
  const title = mode === "setup" ? "Set up AI" : "Set up AI";
  const readyTitle = "You're all set!";
  const subtitle = "Add your AI provider API keys to get started";
