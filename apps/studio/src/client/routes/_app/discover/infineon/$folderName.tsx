...
export const Route = createFileRoute("/_app/discover/infineon/$folderName")({
  ...
  head: ({ loaderData, params }) => {
    return {
      meta: [
        {
          title: `${loaderData?.title ?? params.folderName} · Infineon Templates`,
        },
  ...
  return (
    <TemplateDetail
      breadcrumbItems={[
        ...
        { label: "Infineon Templates", to: "/discover/infineon" },
