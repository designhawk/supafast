...
const Switch = class {
    ...
    render() {
        return (index.h("div", { key: 'e7fca418018b3852de480b7dd76d9a5b0255e33c', class: "container", role: "switch", "aria-checked": this.checked ? "true" : "false", "aria-disabled": this.disabled ? "true" : "false", "aria-labelledby": "switch-label", tabIndex: this.disabled ? -1 : 0, onClick: () => this.toggleSwitch(), onKeyDown: (event) => this.handleKeyDown(event) }, index.h("div", { key: 'd656f05fd9ab19a5807c7591212f6a1e312dc036', class: `switch__checkbox-container ${this.checked ? "checked" : ""} ${this.disabled ? "disabled" : ""}` }, index.h("div", { key: '3bfd7296ddf13db84b34fc0ea5697904eebb94e7', class: "switch__checkbox-wrapper" }, index.h("input", { key: 'ca6ac50abd325b006651dd22205822911ce3b350', type: "checkbox", hidden: true, name: this.name, disabled: this.disabled, checked: this.checked, value: this.value }), index.h("div", { key: '783f4a62a811f37f01b5a2eb522854bb6db5c41d', class: `switch ${this.checked ? "checked" : ""} ${this.disabled ? "disabled" : ""}` }))), index.h("div", { key: '34518eec5f0eda6cc109a4c73895da01d4ae26fc', class: `switch__label-wrapper ${this.disabled ? "disabled" : ""}` }, index.h("label", { key: 'd196c0c4fb7188571ea3890520f6221b3791822e', htmlFor: "switch" }, index.h("slot", { key: '574daab8938c8f2221b93e5514e9d86d559645a2', onSlotchange: () => this.toggleLabelGap() })))));
    }
...
//# sourceMappingURL=ifx-switch.entry.cjs.js.map
