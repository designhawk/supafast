...
const IfxFilterTypeGroup = class {
    constructor(hostRef) {
        ...
        this.ifxSidebarFilterChange = index.createEvent(this, "ifxSidebarFilterChange", 7);
    }
  ...
  connectedCallback ensures that the event listeners are properly set up again */
    ...
    render() {
        return (index.h(index.Host, { key: 'fa23a5623122875d0fb73f00e3137eb8d5b3b2d8' }, index.h("div", { key: '26ccb7ed20d68e0a5ed26edb224700bf93502470', class: "filter-type-group" }, index.h("slot", { key: '9e0ccf0628230109ff143c1037bca05b01e962d1', name: "filter-search" }), index.h("slot", { key: 'e124f556423c8c255df6fbacce64a922767142dc', name: "filter-accordion" }))));
    }
};
IfxFilterTypeGroup.style = filterTypeGroupCss();

exports.ifx_filter_type_group = IfxFilterTypeGroup;
//# sourceMappingURL=ifx-filter-type-group.entry.cjs.js.map

//# sourceMappingURL=ifx-filter-type-group.cjs.entry.js.map