...
const Chip = class {
    ...
    async componentDidLoad() {
        if (!domUtils.isNestedInIfxComponent(this.chip)) {
            ...
            tracking.trackComponent("ifx-chip", await framework);
        }
    }
    render() {
        return (index.h("div", { key: '00f3dc7448c3a2c0116d3102de633c0a80e4d194', class: "chip" }, index.h("div", { key: '4747b74751dabc76e87a5493142650bd17809019', class: `chip__wrapper chip__wrapper--${this.size ? this.size : "medium"}
                ...
                : undefined, role: "combobox", "aria-label": this.ariaLabel, "aria-value": this.getSelectedOptions(), "aria-haspopup": !this.readOnly ? "listbox" : undefined, "aria-expanded": !this.readOnly ? this.opened.toString() : undefined, "aria-controls": !this.readOnly ? "dropdown" : undefined, "aria-readonly": this.readOnly ? "true" : undefined, "aria-multiselectable": this.variant === "multi" ? "true" : undefined }, this.icon && (index.h("div", { key: 'a27f8d20add277778261a4c9c1bb8fa2014fa8de', class: "icon__wrapper" }, index.h("ifx-icon", { key: '034f39df1f7117b590d1638f358b506fdf070557', icon: this.icon }))), index.h("div", { key: '1761d90ebb8a08a58ee147def633058d818d912a', class: "wrapper__label" }, this.selectedOptions.length === 0 && `${this.placeholder}`, this.selectedOptions.length !== 0 &&
            this.variant === "multi" &&
            this.placeholder !== "" &&
            `${this.placeholder}:`, this.selectedOptions.length !== 0 && (index.h("div", { key: '59390d68dc73ac54963ccda688706e09e5da6100', class: "label__selected-options" }, this.getSelectedOptions())), this.selectedOptions.length > 2 && this.variant === "multi" && (index.h("ifx-indicator", { key: 'f7c365a36af4c19b952790277caa8e1c19dcf84a', variant: "number", inverted: this.theme === "outlined" ? false : true, number: this.selectedOptions.length - 2 }))), !this.readOnly &&
            (this.variant !== "multi" ||
                (this.variant === "multi" &&
                    this.selectedOptions.length === 0)) && (index.h("div", { key: 'b6c27c0e3b890300030d5c9369ac0446f94dfb3b', class: "wrapper__open-button" }, index.h("ifx-icon", { key: 1, icon: `chevron-down-16` }))), this.selectedOptions.length >= 1 && this.variant === "multi" && (index.h("div", { key: '3ea341f27bd6476639d558b9c91ac72e4eee79f9', class: "wrapper__unselect-button", onClick: !this.readOnly && !this.disabled
                ? (e) => {
                    this.handleUnselectButtonClick(e);
                }
                : undefined }, index.h("ifx-icon", { key: 2, icon: `cross16` })))), this.opened && !this.readOnly && (index.h("div", { key: '028b582a3d8401cc699d14bd59daba01b60c3be0', id: "dropdown", role: "listbox", class: "chip__dropdown" }, index.h("slot", { key: '266f693738851d3b6b471bbd9a6e844034e95509' })))));
    }
...
const ChipItem = class {
    ...
    render() {
        return (index.h("div", { key: '4d2245f4c4da836f60a3dbb77fe76db38eb8b36d', class: `chip-item chip-item--${this.chipState.size} 
                    chip-item--${(this.selected && this.chipState.variant) === "single" ? "selected" : ""}`, tabIndex: 0, onClick: () => {
                this.handleItemClick();
            }, onKeyDown: (e) => {
                this.handleItemKeyDown(e);
            }, role: "option", "aria-selected": this.selected.toString() }, this.chipState.variant === "multi" && (index.h("ifx-checkbox", { key: '516aadec9eceba16011531f406d41f5e4ab0668f', checked: this.selected, tabIndex: -1, size: "s" })), index.h("div", { key: '319e918bf893498f9f15859833e64f071f2c9775', class: "chip-item__label" }, " ", index.h("slot", { key: '3e9a5f0fee83e6917a27302532000757c22d49ca' }), " "), index.h("div", { key: 'b01c487bffd42cc49268b4c91cb979e156457f29', class: "chip-item__selected-indicator" }, index.h("ifx-icon", { key: 'b89353251f67f0e068810dc5795f6591bb84fc8e', icon: "check-16" }, " "))));
    }
    static get watchers() { return {
        "selected": [{
                "validateSelected": 0
...
const Pagination = class {
    ...
    render() {
        return (index.h("div", { key: '1a7e9f420d6d05115474e0687853207790b711f3', class: "container" }, this.showItemsPerPage && (index.h("div", { key: '10bba45b2e9ac9255111ae503e707f12323a0f66', class: "items__per-page-wrapper" }, index.h("div", { key: '90ed8b8ba7734eb44b9208058698204f2471dc79', class: "items__per-page-label" }, "Results per Page"), index.h("div", { key: '1775ce7abcdefa82670cc521bdd2cacfd2e017f8', class: "items__per-page-field" }, index.h("ifx-select", { key: '057c807d88b7ebeeb8c5c2828b8b43b83a5fa32c', id: "itemsPerPageSelect", placeholder: "false", "show-search": "false", value: undefined, disabled: false, error: false, size: "s", options: this.filteredItemsPerPage, "placeholder-value": "Select" })))), index.h("div", { key: 'a4cfcaf23feef6856849239302d8ceb45820a25d', class: "items__total-wrapper" }, index.h("div", { key: 'e2487f7b8fbaa9d283bbc0a1d036fcc3f4848109', class: "pagination" }, index.h("ifx-icon-button", { key: 'bcaabe30551b47a4a03226ddbdc44017d1fb0547', class: "prev", icon: "arrow-left-16", "aria-label": "Previous Page", onClick: () => this.changePage(this.internalPage - 1), variant: "secondary" }), index.h("ol", { key: '555db71408f416a74ad0c0f7414bd8228c7ffae5' }, this.visiblePages.map((page, i) => typeof page === "number" ? (index.h("li", { key: `page-${page}`, class: { [this.CLASS_ACTIVE]: page === this.internalPage }, "data-page": page }, index.h("span", { class: "page__button", role: "button", tabindex: "0", "aria-current": page === this.internalPage ? "page" : undefined, "aria-label": `Page ${page}`, onClick: () => this.changePage(page), onKeyDown: (e) => (e.key === "Enter" || e.key === " ") &&
                this.changePage(page) }, page))) : (index.h("li", { class: "ellipsis", key: `ellipsis-${i}` }, index.h("span", { "aria-hidden": "true" }, "..."))))), index.h("ifx-icon-button", { key: '0f39a25a83b88078c9a6268740e3400846fcd449', class: "next", icon: "arrow-right-16", "aria-label": "Next Page", onClick: () => this.changePage(this.internalPage + 1), variant: "secondary" })))));
    }
    static get watchers() { return {
        "total": [{
                "watchTotalHandler": 0
