    ...
    render() {
        ...
        const filterClass = this.filterOrientation === "topbar"
            ...
            : this.filterOrientation === "none"
                ? ""
                : "sidebar-layout";
        return (index.h(index.Host, { key: '2ac4193645168102ca1b9546414fe9678802c884' }, index.h("div", { key: '493c6e14e39f2157d4c6177a15fb8331a363535f', class: "table-container" }, this.filterOrientation === "sidebar" && (index.h("div", { key: '92d9603e86d277abefddc102bafe61533d489418', class: "sidebar-btn" }, index.h("ifx-button", { key: 'adb9f6614ed572ef5c05a10740af31eb771b01b5', type: "button", disabled: false, variant: "secondary", size: "m", target: "_blank", theme: "default", "full-width": "false", onClick: () => this.toggleSidebarFilters() }, index.h("ifx-icon", { key: '7d5ef897d035e6db51e687fc7ea5bfb96db8dde4', icon: "cross-16" }), this.showSidebarFilters ? "Hide Filters" : "Show Filters"))), index.h("div", { key: '40d3479cdc9ee298c50dea00f186c3ab750beeef', class: filterClass }, this.filterOrientation === "sidebar" &&
            this.showSidebarFilters && (index.h("div", { key: '9d80da2c155da5cf8ad6a623bbb3da7d756e0708', class: "sidebar-container" }, index.h("div", { key: '47c2fca6d64ecdb997512600b5982882f0fd878d', class: "filters-title-container" }, index.h("span", { key: 'a14b2739a0268615af8f4b272844ef3fb89a10e1', class: "filters-title" }, "Filters")), index.h("div", { key: '748a8d62e16c0f7c2c7188fde7fc5a5e178c7484', class: "set-filter-wrapper-sidebar" }, (this.filterOrientation !== "sidebar" ||
            this.showSidebarFilters) && (index.h("slot", { key: '6cbe0e786f80ea4294051e01c93c591055102075', name: "sidebar-filter" }))))), this.filterOrientation !== "none" &&
            this.filterOrientation !== "sidebar" && (index.h("div", { key: '598aa463277ca6b4b3d97a7d11bf4382bb2af5a0', class: "set-filter-wrapper-topbar" }, (this.filterOrientation !== "sidebar" ||
            this.showSidebarFilters) && (index.h("slot", { key: 'b0a510ebc6db4369f5c78dbab7ff9d91a9a25bea', name: "topbar-filter" })))), index.h("div", { key: 'f89d2406d7d0b7b6ff0da668235bcfc346c4c523', class: "table-pagination-wrapper" }, this.filterOrientation !== "none" &&
            this.filterOrientation !== "topbar" &&
            this.showSidebarFilters && (index.h("div", { key: '1fdf39b651f49433aae464287b15bb418e891765', class: "filter-chips" }, Object.keys(this.currentFilters).map((name) => {
        ...
        }))), index.h("div", { key: '3541f80804cc083a9e5e9cdc7333eb2a7ce9b492', class: "headline-wrapper" }, this.filterOrientation !== "none" && this.headline && (index.h("div", { key: '6e8a0d9658bbec3f289b373871424849e46240f6', class: "matching-results-container" }, index.h("span", { key: '6e5485e27e8bbad29577b07d29221722b5c4e6d8', class: "matching-results-count" }, "(", this.matchingResultsCount, ")"), index.h("span", { key: '94d64a29864194716e5312e9cddd255ae8fcec33', class: "matching-results-text" }, this.headline))), index.h("div", { key: '9a2e3b0269ebe7e7c2a888e92555f0d17bc8822f', class: "inner-buttons-wrapper" }, index.h("slot", { key: '584d6145c575295285e338f6971f2fb9f5dbc167', name: "inner-button" }))), index.h("div", { key: '174c9b586d3e12fb576d4626b461eaec228b3a9a', id: "table-wrapper", class: this.getTableClassNames() }, index.h("div", { key: '068107c805d04ef04001f60ee35653a1d57f55ea', id: `ifxTable-${this.uniqueKey}`, class: `ifx-ag-grid ${this.variant === "zebra" ? "zebra" : ""}`, style: style, ref: (el) => (this.container = el) })), index.h("div", { key: '97153c5cfa4eaeae79ef0e7cca454c777bb52949', class: "pagination-wrapper" }, this.pagination ? (index.h("ifx-pagination", { total: this.serverSidePagination
...
//# sourceMappingURL=ifx-table.entry.cjs.js.map

//# sourceMappingURL=ifx-table.cjs.entry.js.map