...
const Status = class {
    ...
    render() {
        ...
        const containerClass = this.border
            ...
            : "container no-border";
        return (index.h("div", { key: '6348c96a80c7af32942af500926b2e8126bc1497', role: "status", class: containerClass }, index.h("span", { key: 'e4936e37f36f76d8d840c8f7f4f8446172c4f167', class: `dot ${effectiveColor}` }), index.h("p", { key: '3151bc179108afed160cfc559a2c9dd958c62971', class: "text" }, this.label)));
    }
};
Status.style = statusCss();

exports.ifx_status = Status;
//# sourceMappingURL=ifx-status.entry.cjs.js.map
