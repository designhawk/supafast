...
const IfxModal = class {
    ...
    async componentDidLoad() {
        if (!domUtils.isNestedInIfxComponent(this.hostElement)) {
            ...
            tracking.trackComponent("ifx-modal", await framework);
        }
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '008fbc7834af881f1f83fad5969de9413234dcf1' }, index.h("div", { key: '463be31d3d392a74d4a320c6ba85d5ed6f2110c4', ref: (el) => (this.modalContainer = el), class: `modal-container ${this.showModal ? "open" : ""}` }, index.h("div", { key: '6faa7554a20b0ff3cc8936ff2c5000f9d8b369c7', class: "modal-overlay", onClick: () => this.handleOverlayClick() }), index.h("div", { key: '10faaf5e2fa937fc798832e6494c481b35e8191d', "data-focus-trap-edge": true, onFocus: this.handleTopFocus, tabindex: "0" }), index.h("div", { key: '41b6f467807149c4cf9536061778fd5e36f4bcfe', class: `modal-content-container ${this.size}`, role: "dialog", "aria-modal": "true", "aria-label": this.captionAriaLabel }, isAlertVariant ? (index.h("div", { class: `modal-icon-container ${this.variant === "alert-brand" ? "" : "danger"}` }, this.alertIcon ? index.h("ifx-icon", { icon: this.alertIcon }) : null)) : null, index.h("div", { key: '37c30fd79a56cbadd3f79e7f596d22e42c22e17f', class: "modal-content" }, index.h("div", { key: 'f2768063f880f0d0798133ca96fd48d581d07e19', class: "modal-header" }, index.h("h2", { key: '555bd64f9497dbcc427daad374702898be26e6ae', class: "modal-caption" }, this.caption), this.showCloseButton && (index.h("ifx-icon-button", { key: '643a01dafe6016633df9168b73de291bb316d49c', class: "modal-close-button", ref: (el) => (this.closeButton = el), icon: "cross-16", variant: "tertiary", onClick: () => this.doBeforeClose("CLOSE_BUTTON") }))), index.h("div", { key: '4552045290c07ec4af5901753af782a72b986e00', class: "modal-body" }, index.h("slot", { key: '701023071608c7327c0dede53672a8dc0ab1802f', name: "content", onSlotchange: (e) => this.handleContentUpdate(e) })), index.h("div", { key: '86d677ebd4ea6c3419e9b3770cdd31f0390e3a4b', class: `modal-footer ${this.slotButtonsPresent ? "buttons-present" : ""}` }, index.h("slot", { key: '09de03d90552533cce0f38985f0602f904f0aed0', name: "buttons", onSlotchange: (e) => this.handleButtonsSlotChange(e) })))), index.h("div", { key: '2499612267b3b2076d2b6a49f9a5410178c39e24', "data-focus-trap-edge": true, onFocus: this.handleBottomFocus, tabindex: "0" }))));
    }
