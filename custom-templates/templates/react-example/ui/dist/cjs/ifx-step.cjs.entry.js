...
const Step = class {
    ...
    render() {
        return (index.h("div", { key: '6eb47b6c6eb18914bb43303de02932b181a723ab', "aria-current": this.active ? "step" : false, "aria-disabled": this.active || this.complete ? false : true, onClick: (e) => this.stopOnClickPropogation(e), class: `step-wrapper ${this.stepId === 1 ? "first-step" : ""} 
                        ${this.error ? "error" : ""}
                        ...
                        ${this.disabled ? "disabled" : ""}` }, index.h("div", { key: '967cc762254a0830dfde1646a9fbaaad17a2f0e3', class: "step-icon-wrapper" }, this.stepperState.variant !== "compact" && (index.h("span", { key: '487c6304e23d1c6b72c25c199730830547a86d32', class: "step-connector-l" })), this.stepperState.variant !== "compact" &&
            (!this.error || (this.error && this.active)) && (index.h("div", { key: '4bc537571aca9f2cbd946dfcb993ac0c5ba3e509', class: "step-icon" }, this.stepperState.showStepNumber &&
            !this.complete &&
            !this.active
            ? this.stepId
            : "", this.complete && !this.active && (index.h("ifx-icon", { key: 'a84eeec2b999ea30712b60b71b56de1bdad84f65', icon: "check16" })), this.active && index.h("span", { key: '5b5a077d73cfd63a79c887133f4911cb3338c172', class: "active-indic" }))), this.stepperState.variant !== "compact" &&
            this.error &&
            !this.active && (index.h("ifx-icon", { key: 'ffe3e588b8312917e244e7ab3a77453e1f448fea', class: "error-icon", icon: "warningF16" })), this.stepperState.variant !== "compact" && (index.h("span", { key: '4306f9d8aff16d2a8e87e3d4b59c93bd6b1ca3ab', class: `step-connector-r ${this.active ? "active" : ""}` }))), 
        /* Step labels */
        (this.stepperState.variant !== "compact" ||
            (this.stepperState.variant === "compact" &&
                (this.active ||
                    this.stepId === this.stepperState.activeStep + 1))) && (index.h("div", { key: '71d82ed109b8f5f0f63d6bfeee80ad39cec0a052', tabIndex: !this.disabled && this.complete && !this.active ? 0 : -1, class: `step-label ${this.stepperState.variant === "compact" ? (this.active ? "curr-label" : "next-label") : ""}`, onClick: () => {
                this.handleStepClick();
            }, onKeyDown: (e) => {
                this.handleStepKeyDown(e);
            } }, this.stepperState.variant !== "compact" && index.h("slot", { key: '908f81da6852610cfe79afc325ff7baff40e46e7' }), this.stepperState.variant === "compact" && !this.active
            ? "Next: "
            : "", this.stepperState.variant === "compact" && index.h("slot", { key: '9df00263f4142f060e4d311b4f90cb8ad6ad58dd' })))));
    }
...
//# sourceMappingURL=ifx-step.entry.cjs.js.map
