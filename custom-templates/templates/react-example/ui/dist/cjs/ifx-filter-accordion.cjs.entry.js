...
const FilterAccordion = class {
    ...
    render() {
        return (index.h("div", { key: '17fbd1f9def94f7338a92ed159b560cdb0ea5c20', class: `accordion ${this.expanded ? "expanded" : ""}` }, index.h("div", { key: 'd4950dd73670b9a8efa055706e415e4c6b92fae0', class: `header ${this.expanded ? "expanded" : ""}`, onClick: this.toggleAccordion }, index.h("div", { key: '996c5f20064e200a9c56e11e704c8f37b757729a', class: `text-and-icon ${this.expanded ? "expanded" : ""}` }, index.h("div", { key: '40e21cce69fe8673f636a1622e63ee1ba54b2c1f', class: "text" }, index.h("span", { key: '421652b4f84e604d0c815cddfeead5861099d718' }, this.filterGroupName), index.h("ifx-indicator", { key: 'dd9a758c3110680250506f31907a6c7e6521f8c4', variant: "number", number: this.count })), index.h("ifx-icon", { key: '6adbedf280099f79126f9e1b36af39778b1ead72', class: this.expanded ? "" : "hidden", icon: "minus-16", onClick: this.toggleAccordion }), index.h("ifx-icon", { key: '6b44875586538252c679312b776f1e43d4e39cb3', class: this.expanded ? "hidden" : "", icon: "plus-16", onClick: this.toggleAccordion }))), this.expanded && (index.h("div", { key: '2ed695afacb26e541c6c1a2ed1d8b68a90c1688f', class: "filter-accordion-container" }, index.h("slot", { key: 'ca3575022f9700040ec57e7b345b66896bd56bf9', name: "list" })))));
    }
};
FilterAccordion.style = filterAccordionCss();

exports.ifx_filter_accordion = FilterAccordion;
//# sourceMappingURL=ifx-filter-accordion.entry.cjs.js.map

//# sourceMappingURL=ifx-filter-accordion.cjs.entry.js.map