...
const DatePicker = class {
    ...
    async componentDidLoad() {
        if (!domUtils.isNestedInIfxComponent(this.el)) {
            ...
            tracking.trackComponent("ifx-date-picker", await framework);
        }
    ...
    // }
    render() {
        return (index.h("div", { key: 'c012b90fdbb54a2fceb919c65a4c1703a140cfe6', class: `date__picker-container ${this.error ? "error" : ""} ${this.disabled ? "disabled" : ""}` }, index.h("label", { key: 'edc1c275125e427b4dac448507d6dfcf12a8c123', class: "label__wrapper", htmlFor: this.inputId }, this.label?.trim(), index.h("span", { key: 'd84ba225c6c3c5281dd896758d7c22a308a921b6', class: `asterisk ${this.required ? "required" : ""} ${this.error ? "error" : ""}` }, "*")), index.h("div", { key: '2b20b0c19aee685303a823b23b81b179c43200f3', class: `input__wrapper ${this.size === "l" ? "large" : "small"} ${this.disabled ? "disabled" : ""}` }, index.h("input", { key: '34dfea85e5f7e8e5dff738344781b84ef487568f', type: this.type, autocomplete: this.autocomplete, class: `date__picker-input ${this.error ? "error" : ""} ${this.success ? "success" : ""}`, disabled: this.disabled ? true : undefined, "aria-invalid": this.error ? true : undefined, "aria-label": this.ariaLabel, max: this.max, min: this.min, value: this.value, required: this.required, onChange: (e) => this.getDate(e) }), index.h("div", { key: '4907fb288f5a285afd87b49f4e262f3856bc30b8', class: "icon__wrapper", tabIndex: this.isFirefox() ? 0 : undefined, onKeyDown: (e) => this.handleIconKeyDown(e) }, index.h("ifx-icon", { key: '6f1673724fd9f2fbafa06ffbbe9077e20af57ea6', icon: "calendar16", "aria-hidden": "true" }))), this.caption?.trim() && (index.h("div", { key: 'c31292b72751311d5d05b274c020d6af71c67b2c', class: "caption__wrapper" }, this.caption.trim()))));
    }
};
let datePickerId = 0;
...
//# sourceMappingURL=ifx-date-picker.entry.cjs.js.map
