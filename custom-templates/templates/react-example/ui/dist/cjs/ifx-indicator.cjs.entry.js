...
const Indicator = class {
    ...
    async componentDidLoad() {
        if (!domUtils.isNestedInIfxComponent(this.el)) {
            ...
            tracking.trackComponent("ifx-indicator", await framework);
        }
    }
    componentWillUpdate() {
        this.handleNumber();
    ...
    render() {
        return (index.h("div", { key: '897dbea43ffd2fb4d15cc1c6b109f8835e838237', "aria-label": this.ariaLabel, class: "indicator__container" }, this.variant === "number" && (index.h("div", { key: '0fbea4c3ab0db12c0e18fa206bc2404664497787', class: `number__container ${this.inverted ? "inverted" : ""}` }, index.h("div", { key: '77faab8eb00a1e3f0112fc8e107f5b48f20cef88', class: "number__wrapper" }, this.filteredNumber))), this.variant === "dot" && index.h("div", { key: 'd6019acf06f6e9e3120a03a6ea7307c02ce2851a', class: "dot__wrapper" })));
    }
};
Indicator.style = indicatorCss();

exports.ifx_indicator = Indicator;
//# sourceMappingURL=ifx-indicator.entry.cjs.js.map
