...
const Stepper = class {
    ...
    render() {
        return (index.h("div", { key: '44ed5caa2171653734e0002277ce1547920e13a1', "aria-label": this.ariaLabel, "aria-current": this.ariaCurrent, role: "navigation", class: `stepper ${this.variant !== "compact" && this.variant !== "vertical" ? "default" : this.variant} ${this.variant === "compact" ? "compact-" + this.indicatorPosition : ""}` }, 
        /* Progress bar for compact variant. */
        this.variant === "compact" && (index.h("div", { key: 'dab9f18560d96efecc559f654e49b2632af4c855', class: "stepper-progress" }, index.h("div", { key: '6e5e672b305997c57375340d20f9de4de1b51cc1', class: "progress-detail" }, `${Math.min(this.activeStep, this.stepsCount)} of ${this.stepsCount}`))), index.h("div", { key: '65e2c9f82785df44fc06aeb0f7ac5d151f02ff52', class: `stepper-wrapper` }, index.h("slot", { key: 'bf6563894f9d5ff00ca86bd2fe3286d523d6ab02' }))));
    }
    componentDidRender() {
...
//# sourceMappingURL=ifx-stepper.entry.cjs.js.map
