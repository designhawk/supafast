...
const Multiselect = class {
    ...
    async componentDidLoad() {
        if (!domUtils.isNestedInIfxComponent(this.el)) {
            ...
            tracking.trackComponent("ifx-multiselect", await framework);
        }
        setTimeout(() => {
    ...
    render() {
        ...
        return (index.h("div", { key: '4e19eee53f458103cdc03851f7f0ba0db1b7ab24', class: `ifx-multiselect-container ${this.disabled && !this.error ? "disabled" : ""}`, ref: (el) => (this.dropdownElement = el) }, index.h("div", { key: '9f7bb71003ce3687e4a316203b42118cc7e640af', class: "ifx-label-wrapper" }, this.label && (index.h("span", { key: 'd215d4d4cb8c318f318988f6d1d7b1d420a57bc4', class: "wrapper-label" }, index.h("span", { key: '1c638aad8c1c6c5b579e7aefe55d8cf933b5b8cf' }, this.label), this.required && (index.h("span", { key: '741befc8bd52c952144963cb934a5137051d4278', class: `required ${this.error ? "error" : ""}` }, "*"))))), index.h("div", { key: 'fc7e0b1037fdb0d9960b49dcdf66e922981e2570', class: `ifx-multiselect-wrapper
        ...
        ${this.disabled && !this.error ? "disabled" : ""}`, role: "combobox", "aria-label": this.ariaMultiSelectLabel, "aria-labelledby": this.ariaMultiSelectLabelledBy || undefined, "aria-describedby": this.ariaMultiSelectDescribedBy || undefined, "aria-expanded": this.dropdownOpen, "aria-haspopup": "listbox", "aria-disabled": this.disabled && !this.error, tabindex: "0", onClick: this.disabled && !this.error
                ...
                ? undefined
                : (event) => this.handleKeyDown(event) }, index.h("div", { key: '0201f2d814edd5d1419b40d9fcf46f0199f1478f', class: `ifx-multiselect-input
          ${hasSelections ? "" : "placeholder"}
          `, onClick: this.disabled && !this.error
                ? undefined
                : () => this.toggleDropdown() }, hasSelections ? selectedOptionsLabels : this.placeholder), this.dropdownOpen && (index.h("div", { key: '0cd349f15be478d2d45ee6c210449371e9c40972', class: "ifx-multiselect-dropdown-menu" }, (this.showSearch ||
            this.showSelectAll ||
            (this.showExpandCollapse && !isFlatMultiselect)) && (index.h("div", { key: '50ef9d298ebe178f2d3cbd5160eb150b8a3209ca', class: "ifx-multiselect-dropdown-functions", onClick: (e) => e.stopPropagation() }, this.showSearch && (index.h("div", { key: '0fd4dadbeeb4d62b2c106e9af8a0282c4ee0f919', class: "ifx-multiselect-dropdown-search" }, index.h("ifx-search-field", { key: 'e290f2f00763de3951b31d01d89ea01ea284892a', class: "search-input", placeholder: this.searchPlaceholder, size: "s", "show-delete-icon": "true", "aria-label": this.ariaSearchLabel, onKeyDown: (e) => {
                e.stopPropagation();
            }, onIfxInput: (event) => this.handleSearch(event.target), onFocus: () => this.handleSearchFocus(true), onBlur: () => this.handleSearchFocus(false) }))), index.h("div", { key: '19035f2c6c69d3c1347bd0f094e2a3fd2593fc63', class: "ifx-multiselect-dropdown-controls" }, this.showSelectAll && this.renderSelectAll(), this.showExpandCollapse && !isFlatMultiselect && (index.h("div", { key: 'fb8f66a2207dddd9854997bc7c357a2919d6f484', class: "expand-collapse-controls" }, index.h("span", { key: '7b37f0aa6bf1caa7b8ce013fd9b858aa36edcb60', class: "control-item", role: "button", tabIndex: 0, "aria-label": this.ariaExpandAllLabel, onClick: (e) => {
                e.stopPropagation();
                this.expandAll();
            }, onKeyDown: (e) => {
                if (e.key === "Enter" || e.key === " ") {
            ...
            } }, this.expandLabel), index.h("span", { key: '61cbc3cfb9a9ea953a76756d3b408826df744065', class: "control-item", role: "button", tabIndex: 0, "aria-label": this.ariaCollapseAllLabel, onClick: (e) => {
                e.stopPropagation();
                this.collapseAll();
            }, onKeyDown: (e) => {
                if (e.key === "Enter" || e.key === " ") {
            ...
            } }, this.collapseLabel)))))), index.h("div", { key: '0eb3f2c438b647f1eeaf2e8eff736b71696cc764', class: "ifx-multiselect-options", role: "listbox", "aria-multiselectable": "true" }, index.h("slot", { key: '8712ddc2c75db4f869463adc40bd9036ba864141' }), this.searchTerm &&
            this.showNoResultsMessage &&
            this.renderNoResultsMessage()))), index.h("div", { key: 'eef9377329f7293b259bcd7209a7a5f027f121ed', class: "ifx-multiselect-icon-container" }, this.persistentSelectedOptions.length > 0 && (index.h("div", { key: '9563bb568c85172482d506ff8030b91f31562a14', class: `ifx-clear-button ${!this.showClearButton ? "hide" : ""}`, onClick: this.disabled && !this.error
                ? undefined
                : () => this.clearSelection() }, index.h("ifx-icon", { key: '60bb69c165607832c7c7370fd60dc4c6d1d28d25', icon: "cRemove16" }))), index.h("div", { key: 'a11767d740b34ffe49955f26f5d85c552ed959c7', class: "icon-wrapper-up", onClick: this.disabled && !this.error
                ? undefined
                : () => this.toggleDropdown() }, index.h("ifx-icon", { key: "icon-up", icon: "chevron-up-16" })), index.h("div", { key: 'f868228fa05e34ed9d6ed9817aeaa9ce65a946ce', class: "icon-wrapper-down", onClick: this.disabled && !this.error
                ? undefined
                : () => this.toggleDropdown() }, index.h("ifx-icon", { key: "icon-down", icon: "chevron-down-16" })))), this.caption && (index.h("div", { key: 'b0a0c736bf9b564d9008f3a017b8a72d3dbfb9d3', class: `multi__select-caption ${this.error ? "error" : ""} ${this.disabled && !this.error ? "disabled" : ""}` }, this.caption))));
    }
...
const MultiselectOption = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '02456f3eb7c3cb9a43bbed255d0c4f8f7773e637' }, index.h("div", { key: '4496cbfb613844d6643ad8796777b55d4ac06dbd', class: {
                option: true,
                "option--has-children": this.hasChildren,
                "option--expanded": this.isExpanded,
                "option--disabled": this.disabled,
                "option--selected": this.selected,
            }, role: "option", "aria-expanded": this.hasChildren ? (this.isExpanded ? "true" : "false") : undefined, "aria-selected": this.selected ? "true" : "false", "aria-disabled": this.disabled ? "true" : "false", "data-level": this.depth, "data-value": this.value }, index.h("div", { key: '355abb8b4e86fb26b5cf8a878e6c15a70d97b9ae', class: "option-item", style: optionItemStyle }, index.h("div", { key: 'f9623e8ee76f8cee3679b6aaecf130d988e20c9d', class: "chevron-wrapper", tabIndex: this.hasChildren ? 0 : -1, role: this.hasChildren ? "button" : undefined, "aria-label": this.hasChildren
                ? this.isExpanded
                    ? "Collapse"
                    : "Expand"
                : undefined, onClick: (e) => {
            ...
            } }, this.hasChildren && (index.h("ifx-icon", { key: 'd7bb92cbc69bd4ac5f2ce0062070f7b62cf0f0c0', class: `chevron ${this.isExpanded ? "chevron--expanded" : "chevron--collapsed"}`, icon: "chevron-right-16" }))), index.h("div", { key: 'b2abd3d5eb547cd544606b5885e6e93445d5c7ae', class: "checkbox-wrapper", onClick: (e) => e.stopPropagation() }, index.h("ifx-checkbox", { key: 'ea0c810dc4813cebdb993e413b9d9516e0c79618', size: "s", checked: this.isSearchActive && this.isSearchDisabled
                ? false
                : this.indeterminate
                    ? false
            ...
            } })), index.h("div", { key: '95d76f425080089e93fec232bc984b12dd7a1273', class: "option-label", onClick: this.handleHeaderClick, tabIndex: -1 }, index.h("slot", { key: 'd4b55c67d8f31bd8b6dfc4756c1eaa7367b183fd' }))), this.isExpanded && (index.h("div", { key: '4765b74ea8288daf72b6b0f0ce1ecf986f2a0a65', class: "option-children" }, index.h("slot", { key: '75ca13e8068d2f6d2642d44e2f9220a2431b1d41', name: "children" }))))));
    }
};
