...
const RadioButton = class {
    ...
    async componentDidLoad() {
        if (!domUtils.isNestedInIfxComponent(this.el)) {
            ...
            tracking.trackComponent("ifx-radio-button", await framework);
        }
    }
    ...
    render() {
        return (index.h("div", { key: 'a9d3efb5e503305eeff21af8b016b4f50738e15a', role: "radio", "aria-checked": String(this.internalChecked), "aria-disabled": String(this.disabled), class: `radioButton__container ${this.size} ${this.disabled ? "disabled" : ""}`, onClick: (e) => this.handleRadioButtonClick(e), tabindex: this.disabled ? -1 : 0 }, index.h("div", { key: 'b6a8fd604197ca4cfbfbf5ff6981d6ac0c922543', class: `radioButton__wrapper 
            ${this.internalChecked ? "checked" : ""}  
            ${this.error ? "error" : ""}` }, this.internalChecked && (index.h("div", { key: '75b5ac87ead79e2a5174cf522bc99e9a5d53227b', class: "radioButton__wrapper-mark" }))), this.hasSlot && (index.h("div", { key: 'a721984940b528e0ec4d722f36cb5f6211bcb5c5', class: `label ${this.size === "m" ? "label-m" : ""}` }, index.h("slot", { key: '7e9dbd7d4a434db20538aa49fbda8b3b6d7d6281' }))), index.h("input", { key: 'c899b856860b53689ff4d638cd4f0fd91a2fded3', type: "radio", hidden: true, ref: (el) => (this.inputElement = el), name: this.name, value: this.value, checked: this.internalChecked, disabled: this.disabled, onClick: (e) => e.stopPropagation() })));
    }
...
//# sourceMappingURL=ifx-radio-button.entry.cjs.js.map
