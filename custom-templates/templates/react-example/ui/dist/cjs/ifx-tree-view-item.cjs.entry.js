...
const TreeViewItem = class {
    ...
    render() {
        return (index.h("div", { key: '9aab415f6363cfb42b27ec64372dbc10ba564f58', class: {
                "tree-item": true,
                "tree-item--expanded": this.isExpanded,
                "tree-item--has-children": this.hasChildren,
                "tree-item--disabled": this.disabled,
            }, role: "treeitem", "aria-expanded": this.isExpanded ? "true" : "false", "data-level": this.level, "aria-disabled": this.disabled ? "true" : undefined, "aria-label": this.ariaLabel }, index.h("div", { key: '54e902025588fc30671623a3246ad25079f2b471', class: "tree-item__content" }, index.h("div", { key: '9d82af8b1e9027bbe6f4b73f109cec013ed4babd', class: "tree-item__checkbox-container", onClick: (e) => e.stopPropagation() }, index.h("ifx-checkbox", { key: 'a7fc71f1eb2dbb30e6e9df5f99b253299842cfd1', size: "s", checked: this.partialChecked ? false : this.isChecked, indeterminate: this.partialChecked, onIfxChange: this.handleCheckboxChange, disabled: this.disabled })), index.h("div", { key: '700ecdb65e20732a4fe0a30cf05fd9207f884559', class: "tree-item__header", style: { paddingLeft: `${this.level * 24 + 10}px` }, onClick: this.handleHeaderClick, tabIndex: -1, "aria-disabled": this.disabled ? "true" : undefined }, this.hasChildren && (index.h("div", { key: '1b6ed42b76033f14324db742ec7b1d2760873375', class: "tree-item__chevron-container", onClick: this.toggleExpand }, index.h("ifx-icon", { key: 'ec03dae18d7941443336d20f4d0c0a4dbbb54938', class: `tree-item__chevron ${this.isExpanded ? "chevron-down" : "chevron-right"}`, icon: "chevron-right-16" }), index.h("div", { key: '05979928988b2e43f7b572172147bf62129806d3', class: "tree-item__line" }))), index.h("div", { key: 'd5e85a32ba4de10152cec452fc5da951f52ef28d', class: "tree-item__label-icon-container", tabIndex: this.disabled ? -1 : 0, onKeyDown: this.handleKeyDown }, index.h("div", { key: '33221ccadd075833dbe60fe8030e9cf471c0828b', class: "tree-item__icon-container" }, this.hasChildren ? (index.h(index.Fragment, null, index.h("ifx-icon", { class: { "icon--hidden": this.isExpanded }, icon: "folder-16" }), index.h("ifx-icon", { class: { "icon--hidden": !this.isExpanded }, icon: "folder-open-16" }))) : (index.h("ifx-icon", { icon: "file-16" }))), index.h("span", { key: 'b485fedddd71dad05ee86264c9bf4ba13f29f8a0', class: "tree-item__label" }, index.h("slot", { key: '6f51f9308f910d7291b5797af8195b48b2d1b1a5' }))))), this.isExpanded && (index.h("div", { key: 'e1b4fec8f6de6e2e1abddc2da76e01dacd7eb928', class: "tree-item__children" }, index.h("slot", { key: 'd193d748313f2fbcbfdbd943c20935aeec3a4a70', name: "children" })))));
    }
...
//# sourceMappingURL=ifx-tree-view-item.entry.cjs.js.map
