...
const Spinner = class {
    ...
    render() {
        return (index.h("div", { key: '808ec4edf54c536fdcd4e58e46d1d6c3c90ab671', role: "status", "aria-label": this.ariaLabel || "Loading", class: this.getClassNames() }, index.h("div", { key: '5463e132ea9cd98bc8374e0745276f654e95f02a', class: `${this.variant !== "brand" ? "border" : ""} ${this.inverted ? "inverted" : ""}` }), this.variant === "brand" && (index.h("div", { key: '62710d6bfcbde8162afd9efcd663d073e814ca76', class: `semiconductor ${this.inverted ? "inverted" : ""} ${this.getSizeClass()}` }, index.h("svg", { key: '67568b845ebfcc6cb28763413379e1f5ee56bafa', width: "40", height: "40", viewBox: "0 0 40 40", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("g", { key: 'ec1614c8dee943b56730f55629515fed093fe4aa', id: "spinner/conductor" }, index.h("path", { key: 'de7164058a4696a9b5a287cf23f3103fae8fae5e', id: "Vector", d: "M38.75 18.75C39.4375 18.75 40 19.3125 40 20C40 20.6875 39.4409 21.25 38.75 21.25H35V26.25H38.75C39.4375 26.25 40 26.8125 40 27.5C40 28.1875 39.4409 28.75 38.75 28.75H35V30C35 32.7617 32.7617 35 30 35H28.75V38.75C28.75 39.4409 28.1875 40 27.5 40C26.8125 40 26.25 39.4409 26.25 38.75V35H21.25V38.75C21.25 39.4409 20.6875 40 20 40C19.3125 40 18.75 39.4409 18.75 38.75V35H13.75V38.75C13.75 39.4409 13.1875 40 12.5 40C11.8125 40 11.25 39.4409 11.25 38.75V35H10C7.23828 35 5 32.7617 5 30V28.75H1.25C0.559062 28.75 0 28.1875 0 27.5C0 26.8125 0.559062 26.25 1.25 26.25H5V21.25H1.25C0.559062 21.25 0 20.6875 0 20C0 19.3125 0.559062 18.75 1.25 18.75H5V13.75H1.25C0.559062 13.75 0 13.1875 0 12.5C0 11.8125 0.559062 11.25 1.25 11.25H5V10C5 7.23828 7.23828 5 10 5H11.25V1.25C11.25 0.5625 11.8125 0 12.5 0C13.1875 0 13.75 0.559063 13.75 1.25V5H18.75V1.25C18.75 0.559063 19.3091 0 20 0C20.6909 0 21.25 0.559063 21.25 1.25V5H26.25V1.25C26.25 0.559063 26.8091 0 27.5 0C28.1909 0 28.75 0.559063 28.75 1.25V5H30C32.7617 5 35 7.23828 35 10V11.25H38.75C39.4409 11.25 40 11.8091 40 12.5C40 13.1909 39.4409 13.75 38.75 13.75H35V18.75H38.75ZM32.5 10C32.5 8.62188 31.3781 7.5 30 7.5H10C8.62187 7.5 7.5 8.62188 7.5 10V30C7.5 31.3781 8.62187 32.5 10 32.5H30C31.3781 32.5 32.5 31.3781 32.5 30V10Z" })))))));
    }
    getSizeClass() {
...
const TextField = class {
    ...
    async componentDidLoad() {
        if (!domUtils.isNestedInIfxComponent(this.el)) {
            const framework = tracking.detectFramework();
            tracking.trackComponent("ifx-text-field", await framework);
        }
    }
    render() {
        return (index.h("div", { key: 'd66e99e6d9b4006f25a7b7400202b2266f84bbc8', "aria-label": "a text field for user input", "aria-value": this.value, "aria-disabled": this.disabled, class: `textInput__container ${this.readOnly ? "readonly" : ""} ${this.disabled && !this.error ? "disabled" : ""}` }, index.h("div", { key: 'd4215a20ddaadc5c365df4d8e475e51cc937e382', class: "textInput__top-wrapper" }, this.label && (index.h("label", { key: '597e5638a0813c49bb1a125a3f2bdb71200b64c5', htmlFor: this.internalId }, index.h("span", { key: '958424f1aa8517393d63e8352d0612a841bdf969' }, this.label), this.required && (index.h("span", { key: 'd3f267fda6e7d10a40fb70e4f622fd332a905354', class: `required ${this.error && !this.readOnly ? "error" : ""}` }, "*"))))), index.h("div", { key: 'c1a92726a9d8cc9e933746f3fdf9a9f3de856e60', class: "textInput__bottom-wrapper" }, index.h("div", { key: 'a30cfda0677a9c701d581c83c80e07217c55399d', class: "input-container" }, this.icon && index.h("ifx-icon", { key: '27611e13c7eb1b7f22a7c2fedec5ac8d48a7f97b', class: "input-icon", icon: this.icon }), index.h("input", { key: '238113dbc9c34458b0f3214a13314634e4a11b8e', ref: (el) => (this.inputElement = el), disabled: this.disabled && !this.error, autocomplete: this.autocomplete, type: this.internalType, id: this.internalId, value: this.value, onInput: () => this.handleInput(), placeholder: this.placeholder, readonly: this.readOnly, maxlength: this.maxlength, class: `${this.icon ? "icon" : ""}
                ${this.error ? "error" : ""} 
                ${this.readOnly ? "readonly" : ""} 
              ${this.size === "s" ? "input-s" : ""}
              ${this.success ? "success" : ""}` }), this.showDeleteIcon && this.value && (index.h("ifx-icon", { key: '7c2cf0aae4c7d1fc8e036a34ed19fce889b4c0b7', class: "delete-icon", icon: "cRemove16", onClick: () => this.handleDeleteContent() }))), this.caption && (index.h("div", { key: '8724a4a6d8ba9090963b9cb2eb7631b376d59e8e', class: `textInput__bottom-wrapper-caption ${this.error && !this.readOnly ? "error" : ""} ${this.disabled && !this.readOnly && !this.error ? "disabled" : ""}` }, this.caption)))));
    }
...
//# sourceMappingURL=ifx-spinner.ifx-text-field.entry.cjs.js.map

//# sourceMappingURL=ifx-spinner_2.cjs.entry.js.map