...
const BreadcrumbItem = class {
    ...
    render() {
        return (index.h("li", { key: 'c97df1c8c3adc0015158af6f036d4178abd57677', class: "breadcrumb-parent", "aria-current": `${this.isLastItem ? "page" : ""}` }, index.h("li", { key: 'a349a98018f1bd4b5a178661c7296e11acddcdfe', role: "button", tabindex: this.hasDropdownMenu ? 0 : -1, class: "breadcrumb-wrapper", onClick: () => this.toggleDropdownMenu(), "aria-controls": this.uniqueId, "aria-haspopup": "menu", "aria-label": "Toggle dropdown menu" }, index.h("slot", { key: '8d123b993c9445e37667f07e1eb5ea2ea76a4753', name: "label" }), index.h("div", { key: '2a5986954ea62822c919e3933377074bbfa52676', id: this.uniqueId, class: "dropdown-menu", "aria-expanded": this.isDropdownMenuOpen(), "aria-label": "Dropdown menu" }, index.h("slot", { key: 'a0502cabff154555aa1cc8a48ad7db9b52fc826b' }))), !this.isLastItem && (index.h("span", { key: 'f58935a5c17da74ded1cb60314ad976e783b7c93', class: "breadcrumb-divider", "aria-hidden": "true" }, "/"))));
    }
};
BreadcrumbItem.style = breadcrumbItemCss();

exports.ifx_breadcrumb_item = BreadcrumbItem;
//# sourceMappingURL=ifx-breadcrumb-item.entry.cjs.js.map
