...
const FilterSearch = class {
    ...
    render() {
        return (index.h("div", { key: '91bd7376e86f8ddd670e1e14899b2b141bd0a769', class: `${this.filterOrientation === "sidebar"
                ? "sidebar-filter-search-wrapper"
                : "topbar-filter-search-wrapper"}` }, index.h("div", { key: 'e1b0804255ba3fd762b1bd0a669851ae011d6541', class: "filter-name" }, this.filterName), index.h("ifx-search-field", { key: '92ba71f980dafa0ef75aad76db9f3144176d7501', placeholder: this.placeholder, "show-delete-icon": this.showDeleteIcon, disabled: this.disabled, value: this.filterValue })));
    }
...
//# sourceMappingURL=ifx-filter-search.entry.cjs.js.map

//# sourceMappingURL=ifx-filter-search.cjs.entry.js.map