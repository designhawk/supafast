...
const CardHeadline = class {
    ...
    render() {
        return (index.h("div", { key: 'b0f8d9e0293dd753a5e6170fe5d68617ef941f88', class: `card__headline-wrapper ${this.hasDesc ? "withDesc" : ""}` }, index.h("div", { key: '0b314253f35c5614170ad3d374865f052ac23084', class: `card-headline ${this.direction}` }, index.h("slot", { key: '088721fc4ca3f3307c50680d3f69f1f2e4d46184' }))));
    }
};
CardHeadline.style = cardHeadlineCss();

exports.ifx_card_headline = CardHeadline;
//# sourceMappingURL=ifx-card-headline.entry.cjs.js.map
