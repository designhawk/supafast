...
const NavbarItem = class {
    ...
    render() {
        return (index.h("div", { key: '209936e149c3ce077bd61dc0c429eeff59ddc94a', tabIndex: 1, class: "container", onMouseLeave: (e) => this.handleNestedLayerMenu(e), onKeyDown: (e) => this.handleKeyDown(e), onMouseEnter: (e) => this.handleNestedLayerMenu(e) }, index.h("div", { key: 'ac74d160fb0c927840b898408b3bf981ea367999', class: "sub__layer-back-button" }, index.h("div", { key: '9d0dda4db9396199b34aca21ef96b35755a96cfb', class: "back__button-wrapper", onClick: () => this.returnToFirstLayer() }, index.h("ifx-icon", { key: '357904e0eb3e967028948b84a8129e629e34babc', icon: "arrow-left-16" }), index.h("span", { key: 'bbbb7d94e36061000495b64b7ff392cd2a0d9946' }, "Back"))), index.h("a", { key: '274875cf839faecb2601798d09f1c43c6493faea', tabindex: -1, href: this.internalHref, target: this.target, onClick: () => this.toggleItemMenu(), class: `navbar__item ${this.isSidebarMenuItem ? "sidebarMenuItem" : ""} ${!this.showLabel ? "removeLabel" : ""} ${this.isMenuItem ? "menuItem" : ""} ${this.hasChildNavItems ? "isParent" : ""}` }, index.h("div", { key: 'a910bdc5a3d125047300aa3d555b881215b64beb', class: "inner__content-wrapper" }, index.h("div", { key: 'f4f55b0e17f63b5c5bc316fe4db4341cb51d60cc', class: `navbar__container-right-content-navigation-item-icon-wrapper ${!this.icon ? "removeWrapper" : ""}` }, this.icon && index.h("ifx-icon", { key: 'e82d0859ec61ead03bdd8966bd02e8afa51f8ec3', icon: this.icon }), this.icon && !this.showLabel && !isNaN(this.numberIndicator) && (index.h("div", { key: '9a930d739b99c6fc5ecf0b6f62ce040c20e6a26a', class: "number__indicator-wrapper" }, index.h("ifx-indicator", { key: 'b35a864ff304ac7a8c421c1bd28f697fc4eabc96', variant: "number", number: this.numberIndicator }))), this.icon &&
            !this.showLabel &&
            !this.numberIndicator &&
            this.dotIndicator && index.h("div", { key: 'eec0aeeff384926599f8a40460ddd2f2b407f352', class: "dot__indicator-wrapper" })), this.itemPosition === "left" &&
            this.hasChildNavItems &&
            this.isMenuItem && (index.h("div", { key: 'c33ca63875b9ec8befd144feba915fd3f6b40603', class: "menuItemLeftIconWrapper" }, index.h("ifx-icon", { key: 'd69b706e18c3c6893ece23684f1a129e1f998193', icon: "chevron-left-16" }))), index.h("span", { key: '5779b8086cbd9c5c0cef392bdac31789dde13a1c', class: "label__wrapper" }, index.h("slot", { key: '83c7de72b80d53bde58592e66db2f372250eaa81' }))), this.showLabel &&
            this.numberIndicator &&
            !isNaN(this.numberIndicator) ? (index.h("div", { class: "number__indicator-wrapper" }, index.h("ifx-indicator", { variant: "number", number: this.numberIndicator }))) : (""), this.showLabel && !this.numberIndicator && this.dotIndicator ? (index.h("ifx-indicator", { variant: "dot" })) : (""), index.h("div", { key: '500332a377d02d5283787e9605bc1cd5b85ce635', class: `navItemIconWrapper ${this.hasChildNavItems && !this.isMenuItem && !this.isSidebarMenuItem ? "" : "hide"}` }, index.h("ifx-icon", { key: '667474c22d1142f29f6166a7d8d1905dfb89d345', icon: "chevron-down-16" })), index.h("div", { key: 'be0073b6edc9e315da67323dd15bb3c4f69ca2c5', class: `menuItemRightIconWrapper ${(this.itemPosition === "right" && this.hasChildNavItems && this.isMenuItem) || (this.isSidebarMenuItem && this.hasChildNavItems) ? "" : "hide"}` }, index.h("ifx-icon", { key: '794ef399a135a86d1f9fe5c6d78b83aa10135206', icon: "chevron-right-16" }))), this.hasChildNavItems && !this.isSidebarMenuItem && (index.h("ul", { key: 'd28936cadd623fa9e5bfdacf413167fe9a2cfccb', class: "navbar-menu" }, " ", index.h("slot", { key: 'e2059c77d6ae10ffa66c01210bc42ada44f98106', name: "first__layer" }), " ")), this.isSidebarMenuItem && (index.h("ul", { key: '1185f3aa883a57207b9f94b7cd40e5597afa1a60', class: "sub__layer-menu" }, " ", index.h("slot", { key: 'b57e848fe103886d8d96f6967c5ea74156f27d00', name: "second__layer" }), " "))));
    }
};
NavbarItem.style = navbarItemCss();

exports.ifx_navbar_item = NavbarItem;
//# sourceMappingURL=ifx-navbar-item.entry.cjs.js.map
